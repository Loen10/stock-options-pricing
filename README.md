...
The C++ version calculates the a more precise time to expiration by finding the difference in years between the current time and the option's expiration date. This was done
